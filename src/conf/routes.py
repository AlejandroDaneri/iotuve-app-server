...
from src.resources.likes import Likes, LikesList
...
def init_routes(api):
    ...
    api.add_resource(Likes, "/videos/<string:video_id>/likes/me")
    api.add_resource(LikesList, "/videos/<string:video_id>/likes")
